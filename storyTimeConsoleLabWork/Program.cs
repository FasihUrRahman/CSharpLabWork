Console.WriteLine("\t\t\t\tShort Story(The Student)");
Console.WriteLine("\tAT first the weather was fine and still. The thrushes were calling, " +
    ...
    "pools, and it felt cheerless, remote, and lonely in the forest. There was a whiff of winter.\n" +
...
Console.WriteLine("\tThe gardens were called the widows' because they were kept by two widows, " +
